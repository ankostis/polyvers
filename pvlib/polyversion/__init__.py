...
pv_format = '{pname}-{vprefix}{version}'
#: Like :data:`pv_format` but for *mono-project* version-tags.
v_format = '{vprefix}{version}'
...
pv_gitdesc_repat = r"""(?xmi)
    ...
    $
"""
#: Like :data:`pv_format` but for :term:`mono-project` version-tags.
...
def polyversion(**kw):
    ...
    if tag_format is None:
        tag_format = v_format if mono_project else pv_format
